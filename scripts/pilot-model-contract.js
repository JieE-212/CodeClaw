...
const copyRoot = await fs.mkdtemp(path.join(os.tmpdir(), "codeclaw-model-contract-copies-"));
...
try {
  ...
  await restoreFileIfChanged(demoTestPath, originalTest);
  await restoreFileIfChanged(demoSourcePath, originalSource);
