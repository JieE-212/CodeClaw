...
function targetFields() {
  return [
    ...
    target("HUMAN_TRIAL_OBSERVATION.md", "Safe to continue to the next tester", ["Safe to continue to the next tester", "Safe to continue to tester 2", "Safe to continue", "\u662f\u5426\u7ee7\u7eed\u4e0b\u4e00\u4f4d\u6d4b\u8bd5\u8005", "\u662f\u5426\u540c\u610f\u8fdb\u5165 tester-2", "\u662f\u5426\u7ee7\u7eed"], "Is it safe to continue to the next tester? Yes or No."),
    ...
    target("TRIAL_FEEDBACK_TEMPLATE.md", "Should this build continue to the next tester?", ["Should this build continue to the next tester", "Should this build continue to the next tester?", "Should this build go to tester 2", "Should this build go to tester 2?", "Should continue", "\u662f\u5426\u7ee7\u7eed\u4e0b\u4e00\u4f4d\u6d4b\u8bd5\u8005", "\u662f\u5426\u540c\u610f\u8fdb\u5165 tester-2", "\u662f\u5426\u7ee7\u7eed"], "Should this build continue to the next tester? Yes or No."),
    ...
    target("TRIAL_RESULT_RECORD.md", "Proceed to the next tester", ["Proceed to the next tester", "Proceed to tester 2", "Proceed", "\u662f\u5426\u7ee7\u7eed\u4e0b\u4e00\u4f4d\u6d4b\u8bd5\u8005", "\u662f\u5426\u540c\u610f\u8fdb\u5165 tester-2", "\u662f\u5426\u7ee7\u7eed"], "Proceed to the next tester? Yes or No."),
    target("TRIAL_RESULT_RECORD.md", "Required fix before the next tester", ["Required fix before the next tester", "Required fix before tester 2", "Required fix", "\u7ee7\u7eed\u4e0b\u4e00\u4f4d\u6d4b\u8bd5\u8005\u524d\u5fc5\u987b\u4fee\u590d", "\u8fdb\u5165 tester-2 \u524d\u5fc5\u987b\u4fee\u590d", "\u5fc5\u987b\u4fee\u590d"], "What must be fixed before the next tester? Write None if no fix is needed.")
  ];
}
